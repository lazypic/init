...
if [[ `uname` == 'Linux' ]]; then
	...
	if [ -f "/Applications/Pixar/RenderManProServer-20.9" ]; then
...
alias progit="$browser https://git-scm.com/book/ko/v2"
alias weather="curl wttr.in/seoul"
alias class="http://kooc.kaist.ac.kr/1609_machinelearning_1_3/joinLectures/7715"
